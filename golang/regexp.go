...
func main() {
	...
	RE := regexp.MustCompile(".*(test|aaa|bbb){1}.*")
	fmt.Printf("%v\n", (RE.FindStringSubmatch("2test1")))
	fmt.Printf("%v\n", (RE.FindStringSubmatch("1234aaabbb")))
	fmt.Printf("%v\n", (RE.FindStringSubmatch("test1234aaabbb")))
	fmt.Printf("%v\n", (RE.FindStringSubmatch("aabbtes")))
