...
type M3500_API struct {
	Switch
}

func (m M3500_API) IsVlanExist(dev *Device, vid string) (error, string) {
	...
	fmt.Println("Call IsVlanExist on M3500_API")
...
func (m M3500_API) SetInterfaceUp(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) SetInterfaceDown(dev *Device, ifname string) (error, string) {
	fmt.Println("Call SetInterfaceDown with ", ifname, "on M3500_API")
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) IsInterfaceUp(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsInterfaceRunning(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show interface " + ifname})
...
func (m M3500_API) GetInterfaceStatisticsAvg5Sec(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsAvg1Min(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsAvg10Min(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsInUcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsInMcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsInBcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsInDiscardPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsInErrorPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsOutUcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsOutMcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsOutBcastPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsOutDiscardPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) GetInterfaceStatisticsOutErrorPkts(dev *Device, ifname string) (error, string) {
	return nil, ""
}

func (m M3500_API) SetInterfaceSpeed(dev *Device, ifname, speed string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) UnSetInterfaceSpeed(dev *Device, ifname, speed string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) SetInterfaceMtu(dev *Device, ifname, mtu string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) UnSetInterfaceMtu(dev *Device, ifname, mtu string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) SetInterfaceTypeL3(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) SetInterfaceTypeL2(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) AddInterfaceToVlan(dev *Device, ifname, vid, tagged string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
	if tagged == "true" {
...
func (m M3500_API) DelInterfaceFromVlan(dev *Device, ifname, vid, tagged string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
	if tagged == "true" {
...
func (m M3500_API) SetInterfaceIPAddress(dev *Device, ifname, ip string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) SetInterfaceSecondaryIPAddress(dev *Device, ifname, ip string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) UnSetInterfaceIPAddress(dev *Device, ifname, ip string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) UnSetInterfaceSecondaryIPAddress(dev *Device, ifname, ip string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) AddInterfaceToVRF(dev *Device, ifname, vrf string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) DelInterfaceFromVRF(dev *Device, ifname, vrf string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) AddVRF(dev *Device, vrf string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelVRF(dev *Device, vrf string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) AddMcecIntraDomainLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelMcecIntraDomainLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "mcec-domain-configuration"})
...
func (m M3500_API) AddMcecDomainDataLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "mcec-domain-configuration"})
...
func (m M3500_API) DelMcecDomainDataLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "mcec-domain-configuration"})
...
func (m M3500_API) IsMlagDomainUp(dev *Device) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsMlagInSync(dev *Device, mlag_id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) AddMlag(dev *Device, lacp_id, mlag_id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelMlag(dev *Device, lacp_id, mlag_id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface po" + lacp_id})
...
func (m M3500_API) DelMlagAll(dev *Device) (error, string) {
	return fmt.Errorf("mlag does not support on M2400"), "false"
}

func (m M3500_API) IsMlagExist(dev *Device, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) AddLacpInterface(dev *Device, id string) (error, string) {
	return nil, ""
}

func (m M3500_API) DelLacpInterface(dev *Device, id string) (error, string) {
...
func (m M3500_API) DelLacpInterfaceAll(dev *Device) (error, string) {
	defer dev.GoInitMode()
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show etherchannel summary"})
...
func (m M3500_API) AddLacpMember(dev *Device, ifname, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) DelLacpMember(dev *Device, ifname, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface " + ifname})
...
func (m M3500_API) IsLacpUp(dev *Device, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsLacpMemberInSync(dev *Device, id, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) SetLacpTrafficDistMode(dev *Device, id, mode string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) UnSetLacpTrafficDistMode(dev *Device, id, mode string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "interface po" + id})
...
func (m M3500_API) AddRoute(dev *Device, prefix, masklen, nexthop, oif string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelRoute(dev *Device, prefix, masklen, nexthop, oif string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelAllRoute(dev *Device) (error, string) {
...
func (m M3500_API) GetAllStaticRoute(dev *Device) (error, []string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) AddVlan(dev *Device, vid string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelVlan(dev *Device, vid string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) IsInterfaceVlanMember(dev *Device, ifname, vid string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show vlan brief"})
...
func (m M3500_API) IsLacpInterfaceExist(dev *Device, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show interface po" + id})
...
func (m M3500_API) IsInterfaceLacpMember(dev *Device, ifname, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsInterfaceMlagIntraDomainLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsInterfaceMlagDomainDataLink(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show running-config mcec"})
...
func (m M3500_API) IsMlagDomainInSync(dev *Device) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show mlag domain details"})
...
func (m M3500_API) IsInterfaceMlagLocalMember(dev *Device, ifname, mlag_id string) (error, string) {
...
func (m M3500_API) IsInterfaceMlagRemoteMember(dev *Device, ifname, mlag_id string) (error, string) {
	err, index := m.GetInterfaceIndexByName(dev, ifname)
	if err != nil {
		return fmt.Errorf("Cannot get interface %s's index with %s", ifname, err), ""
	}
	...
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show lagd mlag " + mlag_id + " | include Neigh member List"})
...
func (m M3500_API) GetInterfaceIndexByName(dev *Device, ifname string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) AddOspfInstance(dev *Device, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) DelOspfInstance(dev *Device, id string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
...
func (m M3500_API) AddOspfNetwork(dev *Device, id, network, area string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "router ospf " + id})
...
func (m M3500_API) DelOspfNetwork(dev *Device, id, network, area string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "router ospf " + id})
...
func (m M3500_API) SetOspfInstanceRid(dev *Device, id, rid string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "router ospf " + id})
...
func (m M3500_API) UnsetOspfInstanceRid(dev *Device, id, rid string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "configure terminal"})
	cmds = append(cmds, &command.Command{Mode: "config", CMD: "router ospf " + id})
...
func (m M3500_API) IsOspfNeighorUp(dev *Device, id, neigh string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
...
func (m M3500_API) IsOspfNeighorState(dev *Device, id, neigh, state string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
	cmds = append(cmds, &command.Command{Mode: "normal", CMD: "show ip ospf neighbor " + neigh})
...
func (m M3500_API) IsInterfaceState(dev *Device, id, ifname, state string) (error, string) {
	cmds := make([]*command.Command, 0, 1)
