...
var ErrorNoOSPFNeighbour = errors.New("No OSPF neighbor exist")
...
func (rp *RoutePool) Sync() error {
	...
	if rp.Type == OSPF_External {
		_, err = rp.GetExternalLsaPool()
		if err != nil {
			return fmt.Errorf("Cannot sync route pool with: %s", err)
		}
	} else if rp.Type == OSPFV3_External {
		_, err = rp.GetExternalLsaPool6()
		if err != nil {
			return fmt.Errorf("Cannot sync route pool with: %s", err)
		}
	} else {
		return fmt.Errorf("Unkonw route pool type")
	}
...
func (rp *RoutePool) SetForwardingAddress6(fwdr string) error {
	cmd := fmt.Sprintf("%s SetForwardingAddress %s %s", rp.Object, rp.Handler, fwdr)
	_, err := rp.Invoke(cmd)
	if err != nil {
		return fmt.Errorf("Cannot set forwarding address to routepool with: %s", err)
...
func (rp *RoutePool) GetExternalLsaPool6() (*LSAPool, error) {
	//AgtOspfv3ExternalRoutePool GetOspfv3ExternalLsaPool
	cmd := fmt.Sprintf("%s GetOspfv3ExternalLsaPool %s", rp.Object, rp.Handler)
	res, err := rp.Invoke(cmd)
	if err != nil {
		return nil, fmt.Errorf("Cannot get lsa pool of %s with: %s", rp.Handler, err)
	}
	...
	rp.LSAPool = &LSAPool{Handler: res, Object: "AgtOspfv3ExternalLsaPool"}
...
func (o *OSPF) Sync() error {
	...
	if err != nil && err != ErrorNoOSPFNeighbour {
		return fmt.Errorf("Cannot sync ospf with: %s", err)
	}
...
func (o *OSPF) GetNeighbour() (*OSPFNeighbour, error) {
	...
	if o.Neighbour == nil {
		return nil, ErrorNoOSPFNeighbour
	}
...
func (o *OSPF) AddExternalRoute(start, plen, count, step string) error {
	return o.AddExternalPrefixes(start, plen, count, step, "1", "1", "0.0.0.0")
}

func (o *OSPF) DeleteExternalRoute(start string) error {
	return o.RemoveExternalPrefixes(start)
}

func (o *OSPF) AdvertiseExternalRoute(start string) error {
	return o.AdvertiseExternalPrefixes(start)
}

func (o *OSPF) WithdrawExternalRoute(start string) error {
	return o.WithdrawExternalPrefixes(start)
}

func (o *OSPF) AddExternalRoute6(start, plen, count, step string) error {
	return o.AddExternalPrefixes6(start, plen, count, step, "1", "1", "::")
}

func (o *OSPF) DeleteExternalRoute6(start string) error {
	return o.RemoveExternalPrefixes6(start)
}

func (o *OSPF) AdvertiseExternalRoute6(start string) error {
	return o.AdvertiseExternalPrefixes6(start)
}

func (o *OSPF) WithdrawExternalRoute6(start string) error {
	return o.WithdrawExternalPrefixes6(start)
}
...
func (o *OSPF) AddExternalPrefixes6(start, plen, count, step, metric, mtyp, fwdr string) error {
	np, err := o.AddExternalRoutePool6()
	if err != nil {
		return fmt.Errorf("Cannot add ospfv3 external prefix %s with %s", start, err)
	}
	...
	/*
		err = np.SetForwardingAddress6(fwdr)
		if err != nil {
			return fmt.Errorf("Cannot add ospfv3 external prefix %s with %s", start, err)
		}
	*/
...
func (o *OSPF) RemoveExternalPrefixes6(first string) error {
	first = strings.TrimSpace(first)
	rp := o.getExternalRoutePoolByIP(first)
	if rp == nil {
		return fmt.Errorf("Cannot find any external pool by: %s", first)
	...
	return o.RemoveExternalRoutePool6(rp)
}
...
func (o *OSPF) AdvertiseExternalPrefixes6(first string) error {
	rp := o.getExternalRoutePoolByIP(first)
	if rp == nil {
		return fmt.Errorf("Cannot advertise prefixes: %s with cannot find the pool", first)
	}
...
func (o *OSPF) WithdrawExternalPrefixes6(first string) error {
	rp := o.getExternalRoutePoolByIP(first)
	if rp == nil {
		return fmt.Errorf("Cannot withdraw prefixes: %s with cannot find the pool", first)
	}
...
func (o *OSPF) AddExternalRoutePool6() (*RoutePool, error) {
	cmd := fmt.Sprintf("AgtOspfTopology Add %s AGT_OSPFV3_EXTERNAL_ROUTEPOOL", o.LSDB.Handler)
	res, err := o.Invoke(cmd)
	if err != nil {
		return nil, fmt.Errorf("Cannot add ospf external route pool to %s with: %s", o.Handler, err)
	}
	...
	pool := &RoutePool{
		Object:  "AgtOspfv3ExternalRoutePool",
		Type:    OSPFV3_External,
		Handler: strings.TrimSpace(res),
		OSPF:    o,
		Default: !isDefault,
	}
...
func (o *OSPF) RemoveExternalRoutePool(pool *RoutePool) error {
	if pool == nil || pool.Handler == "" || pool.Type != OSPF_External {
...
func (o *OSPF) RemoveExternalRoutePool6(pool *RoutePool) error {
	if pool == nil || pool.Handler == "" || pool.Type != OSPFV3_External {
		return fmt.Errorf("Inavlid route pool to delete")
	}
